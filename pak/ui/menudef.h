...
#define CV_SVS_FASTPANZER		2048
#define CV_SVS_FASTPANZERKILLSPREE		4096
#define CV_SVS_FASTPANZERDEATHCALC		8192

// "cg_ui_voteFlags"
#define CV_SVF_COMP				1L << 0
#define CV_SVF_GAMETYPE			1L << 1
#define CV_SVF_KICK				1L << 2
#define CV_SVF_MAP				1L << 3
#define CV_SVF_MATCHRESET		1L << 4
#define CV_SVF_MUTESPECS		1L << 5
#define CV_SVF_NEXTMAP			1L << 6
#define CV_SVF_PUB				1L << 7
#define CV_SVF_REFEREE			1L << 8
#define CV_SVF_SHUFFLETEAMS		1L << 9
#define CV_SVF_SWAPTEAMS		1L << 10
#define CV_SVF_FRIENDLYFIRE		1L << 11
#define CV_SVF_TIMELIMIT		1L << 12
#define CV_SVF_WARMUPDAMAGE		1L << 13
#define CV_SVF_ANTILAG			1L << 14
#define CV_SVF_BALANCEDTEAMS	1L << 15
#define CV_SVF_MUTING			1L << 16
#define	CV_SVF_GENERIC			1L << 17
#define CV_SVF_MATCHRESTART		1L << 18
#define CV_SVF_STARTMATCH		1L << 19
#define CV_SVF_BOTS				1L << 20
#define CV_SVF_FASTPANZER		1L << 21
#define CV_SVF_FASTPANZERKILLSPREE		1L << 22
#define CV_SVF_FASTPANZERDEATHCALC		1L << 23
#define CV_SVF_FASTPANZERRELOADTIME		1L << 24
