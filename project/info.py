...
class Project:
    def __init__(this, dbFileName):
        initDB = {
            'name'         : 'PARAZIT-Mod',
            'namef'        : 'PARAZIT-Mod',
            'namex'        : '^1PA^3RAZ^4IT^2-Mod',
            'website'      : 'http://parazit.ro',
            'irc'          : 'irc.freenode.net #parazitmod',
            'author'       : 'Gavrila',
            'copyright'    : 'Copyright (c) 2011-2018 Gavrila. All Rights Reserved.',
            'versionMajor' : '2',
            'versionMinor' : '2',
            'versionPoint' : '0',
            'buildDate'    : 'Fri Jan 20 23:05:44 PST 2017',
            'buildRelease' : 'false',
            'repoURL'      : 'disable',
            'repoUUID'     : 'disable',
            'repoRev'      : 'disable',
